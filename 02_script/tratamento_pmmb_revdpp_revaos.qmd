...
Vamos acessar para ver se aquele indivíduo atuou na cidade onde foi destinado em anos anteriores.
...
base_tratada6.2 <- base_tratada6.1 |> 
  mutate(competen_final = as.Date("2023-12-01")) |> 
  mutate(uf_final = ifelse(churn == "permanece", uf_destino, uf_exercicio[competen == competen_final])) |> 
  select(-competen_final, -uf_exercicio)
...
base_tratada28$ibge_aloc <- as.character(base_tratada28$ibge_aloc)

base_tratada29 <- base_tratada28 |> 
