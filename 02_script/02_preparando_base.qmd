...
base_atributos |> 
  group_by(churn) |> 
  summarise(orcamento_saude = round(mean(orcamento_saude),2)) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, taxa_homicidio) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, ideb_anosiniciais) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, ideb_anosfinais) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, investimento_infraestrutura) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, equipamentos_esportivos) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, equipamentos_culturais) |> 
  DT::datatable()
```
