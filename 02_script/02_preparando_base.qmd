...
base_atributos |> 
  group_by(churn) |> 
  summarise(média = mean(leitos_instalacao_fisica_urgencia))
```
...
var_pib <- 
  ...
  mutate(variacao = (ppc_2019 * 100 / ppc_2010) - 100) |> 
  mutate(codigo_municipio = substr(codigo_municipio, 1, 6))

```

# ALEF JUNTAR ESTA BASE AOS ATRIBUTOS

#### 1.4.1.2.2 PIB per capita
...
base_atributos |> 
  group_by(churn) |> 
  summarise(media = round(mean(cobertura_saude),2),
            ) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, orcamento_saude, churn) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, taxa_homicidio, churn) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, ideb_anosiniciais, churn) |> 
  DT::datatable()
```
...
base_atributos |> 
  group_by(churn) |> 
  summarise(média = round(mean(ideb_anosfinais, na.rm = TRUE),2)) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, ideb_anosfinais, churn) |> 
  DT::datatable()
```
...
base_atributos |> 
  group_by(churn) |> 
  summarise(média = round(mean(investimento_infraestrutura),2)) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, investimento_infraestrutura, churn) |> 
  DT::datatable()
```
...
base_atributos |> 
  group_by(churn) |> 
  summarise(média = round(mean(equipamentos_esportivos),2)) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, equipamentos_esportivos, churn) |> 
  DT::datatable()
```
...
base_atributos |> 
  group_by(churn) |> 
  summarise(média = round(mean(equipamentos_culturais),2)) |> 
  DT::datatable()
```
...
base_atributos |> 
  ...
  select(nome, uf_destino, municipio_destino, populacao, pib_percapita, equipamentos_culturais, churn) |> 
  DT::datatable()
```
