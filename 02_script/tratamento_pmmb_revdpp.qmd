...
base_tratada12 <- base_tratada11 |> 
  left_join(equipamentos, by = c("cnes" = "CNES"))
...
```{r}
write_xlsx(base_tratada17, "~/GitHub/sa_maismedicos/01_dados/Editais/2019/base_tratada.xlsx")
```
